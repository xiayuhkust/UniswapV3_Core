...
library Tick {
    ...
    struct Info {
        ...
        // this is cheaper than actually checking if liquidityGross is 0
        bool initialized;
    }
    ...
    function tickSpacingToMaxLiquidityPerTick(int24 tickSpacing) internal pure returns (uint128) {
        ...
        return type(uint128).max / uint128(numTicks);
    }
    ...
    /// @param secondsPerLiquidityX128 The current seconds per liquidity
    ...
    function update(
        ...
        if (liquidityGrossBefore == 0) {
            ...
            if (tick <= tickCurrent) {
                ...
                info.secondsPerLiquidityOutsideX128 = secondsPerLiquidityX128;
